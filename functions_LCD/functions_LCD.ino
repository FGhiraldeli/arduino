...
LiquidCrystal_I2C lcd(0x27, 2, 1, 0, 4, 5, 6, 7, 3, POSITIVE);  // Configura endereço I2C e display com 16 caracteres e 2 linhas 
int thisChar = 0 ;

void setup()
{
  lcd.begin(16, 2);                      // inicializa LCD
  lcd.setBacklight(HIGH);                 // ativa led de backlight
}
